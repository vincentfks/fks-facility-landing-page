...
import { solutionRoutes } from '../../lib/solutions';
import { COMPANY } from '../../seo/site';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6 text-gray-400">
              La centrale d'achat et de référencement des TPE et PME, basée à Massy (91).
              Tarifs négociés sur vos achats généraux, en Île-de-France et partout en France.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/simuler-mes-economies" className="hover:text-primary-400 transition-colors py-1 block">Simuler mes économies</Link></li>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href={`tel:${COMPANY.telephone}`} className="hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <div className="flex flex-wrap justify-center gap-6">
            <span>© {new Date().getFullYear()} FKS FACILITY</span>
