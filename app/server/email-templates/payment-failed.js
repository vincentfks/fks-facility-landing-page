...
export function generatePaymentFailedEmail(paymentIntent) {
  const amount = (paymentIntent.amount / 100).toLocaleString('fr-FR', {
    style: 'currency',
    currency: 'EUR',
  });
  
  const errorMessage = paymentIntent.last_payment_error?.message || 'Une erreur est survenue lors du traitement de votre paiement.';
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div style="text-align: center; margin-top: 32px;">
        <a href="${process.env.FRONTEND_URL || 'https://fks-facility.com'}/tarification" class="button">
